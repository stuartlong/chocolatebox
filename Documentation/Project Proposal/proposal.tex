...
Stuart Long & 2/3/14 & Initial Abstract / Introduction / User Interface / Project Management & 1.0 \\ \hline
James Fitzpatrick & 2/3/14 & Initial Application / Methodology & 1.0 \\\hline
Frank Singel & 2/3/14 & Initial Software Design & 1.0\\\hline
\end{tabularx}
\end{table}
\FloatBarrier
\newpage
